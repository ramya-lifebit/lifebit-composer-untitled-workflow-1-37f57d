...
def helpMessage() {
    ...
    --gwas_sample_size               Number of samples in the input GWAS VCF (int)
                                     (Default: $params.lifebitai_traits_gcta_greml_1.gwas_sample_size)
    --other_gwas_sample_size      Number of samples in the external GWAS VCF (int)
                                     (Default: $params.lifebitai_traits_gcta_greml_1.other_gwas_sample_size)
    """.stripIndent()
}
...
summary['analysis_mode']                  = params.lifebitai_traits_gcta_greml_1.analysis_mode
...
summary['gwas_sample_size']               = params.lifebitai_traits_gcta_greml_1.gwas_sample_size
summary['other_gwas_sample_size']      = params.lifebitai_traits_gcta_greml_1.other_gwas_sample_size
...
workflow lifebitai_traits_gcta_greml_1{
  take:
    ch_plink_gcta_input
    ch_pheno_file
  ...
  main:
    ...
    if (params.lifebitai_traits_gcta_greml_1.analysis_mode == 'heritability') {
      gcta_greml_h2(ch_pheno_file, gcta_calculate_grm.out.gcta_grm)
      gcta_greml_out = gcta_greml_h2.out.gcta_greml
    } else if (params.lifebitai_traits_gcta_greml_1.analysis_mode == 'genetic_correlation') {
